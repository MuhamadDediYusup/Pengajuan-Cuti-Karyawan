            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-header small text-uppercase">
                        <span class="menu-header-text">Pengajuan Cuti</span>
                    </li>
                    <li class="menu-item">
                        <a href="/pengajuan" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div data-i18n="Account Settings">Pengajuan Cuti</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/pengajuan" class="menu-link">
                                    <div data-i18n="Account">Ajukan Cuti</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="pages-account-settings-notifications.html" class="menu-link">
                                    <div data-i18n="Notifications">Status Pengajuan Cuti</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="pages-account-settings-connections.html" class="menu-link">
                                    <div data-i18n="Connections">Data Pengajuan Cuti</div>
                                </a>
                            </li>
                        </ul>
                    </li>
